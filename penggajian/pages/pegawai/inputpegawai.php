        ...
        <form name="frm_unit" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            ...
            <div style="width: 100%; height: 88%; overflow: auto;">
                <table width="100%" align="center">
                    ...
                    <tr class="head">
                        <td width="25%">Jenjang Jabatan</td>
                        <td width="">:</td>
                        <td width="75%">
                    ...
                    <tr class="head">
                        <td width="25%">Kelompok Jabatan</td>
                        <td width="">:</td>
                        <td width="75%">
                    ...
                    <tr class="head">
                        <td width="25%">Tingkat Emergency</td>
                        <td width="">:</td>
                        <td width="75%">
                    ...
                    <tr class="head">
                        <td width="25%">Kode Ms Kerja <?php echo isset($ms_kerja) ? $ms_kerja : NULL; ?></td>
                        <td width="">:</td>
                        <td width="75%">
                    ...
                    <tr class="head">
                        <td width="25%" valign="top">Wajib Masuk</td>
                        <td width="">:</td>
            ...
            if (isset($BtnSimpan)) {
                ...
                if (($photo != "pages/pegawai/photo/") && (strtolower(substr($photo, -3)) != "jpg")) {
                    ...
                    if ((!empty($nik)) && (!empty($jnj_jabatan)) && (!empty($departemen)) && (!empty($bidang)) && (!empty($stts_wp)) && (!empty($stts_kerja)) &&
                        ...
                        empty($nik) || empty($jnj_jabatan) || empty($departemen) || empty($bidang) || empty($stts_wp) || empty($stts_kerja) ||
                        empty($pendidikan) || empty($tgl_lahir) || empty($mulai_kerja) || empty($indexins) || empty($bpd) || empty($kode_kelompok) ||
