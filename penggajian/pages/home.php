<div id="navcontainer">
    <?php
    if ($_SESSION['ses_admin_kepegawaian'] == "admin") {
        echo "
            ...
            <table width='120%' align='center' height='100%'>
                ...
                <tr width='100%' height='14.2%' align='center'> 
                    ...
                    <td width='16%' align='center'>
                        <a href='index.php?act=ListMenuIndikator&action=LIHAT'>                                                  
                                <img src='images/if_vector_65_13_473800.png'/><br>
                                Menu Indikator                                                  
                        </a>
                    </td>
                    <td width='16%' align='center'>
                        <a href='index.php?act=ListRuangan&action=LIHAT'>                                                  
                                <img src='images/Home.png'/><br>
                                Ruangan/Unit                                                  
                        </a>
                    </td>
                    <td width='16%' align='center'>
                        <a href='index.php?act=ListRekap&bulan=januari'>                                                  
                                <img src='images/Home.png'/><br>
    ...
    } elseif ($_SESSION['ses_admin_kepegawaian'] == "paijo") {
