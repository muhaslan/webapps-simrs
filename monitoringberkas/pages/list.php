	    ...
	    <table width="100%" align="center" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr class="head4">
                    <td>
                        ...
                        &nbsp;&nbsp;
                        Keyword : <input name="keyword" class="text" type="text" value="<?php echo $keyword;?>" size="47" maxlength="25" pattern="[a-zA-Z0-9, ./@_]{1,25}" title=" a-zA-Z0-9, ./@_ (Maksimal 25 karakter)" autocomplete="off" autofocus />
