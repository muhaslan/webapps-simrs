    ...
    <div class="entry">
        <form name="frm_unit" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            ...
            if ($action == "TAMBAH") {
                ...
                $_sql           = "SELECT `id_indikator1`, `bulan`, `ruangan`, `numerator`, `denumerator`, `id_menuindikator`,`nm_ruangan` FROM indikator1 JOIN ruangan_unit ON ruangan_unit.id_ruangan = indikator1.ruangan WHERE id_indikator1='$id'";
            ...
            echo "<div align='center' class='link'>
                          ...
                          <a href=?act=ListIndikator1&menu=$menu>| List Data |</a>
            ...
            if (isset($BtnSimpan)) {
                ...
                if ((!empty($bulan)) && (!empty($idruangan)) && (!empty($numerator)) && (!empty($denumerator) && (!empty($menu)) && (!empty($tahun)))) {
                    switch ($action) {
                        case "TAMBAH":
                            Tambah(" indikator1 ", "'0','$bulan','$idruangan','$numerator','$denumerator','$menu','$tahun'", " indikator1 ");
                            echo "<html><head><title></title><meta http-equiv='refresh' content='1;URL=?act=InputIndikator1&action=TAMBAH&menu=$menu'></head><body></body></html>";
                            break;
                        case "UBAH":
                            Ubah(" indikator1 ", " bulan='$bulan',ruangan='$idruangan',numerator='$numerator',denumerator='$denumerator', id_menuindikator='$menu',tahun='$tahun' WHERE id_indikator1='$id'", " indikator1 ");
                            echo "<html><head><title></title><meta http-equiv='refresh' content='1;URL=?act=InputIndikator1&action=UBAH&id=$id&menu=$menu'></head><body></body></html>";
                            break;
                    }
                } else if (
