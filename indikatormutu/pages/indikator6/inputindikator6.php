    ...
    <div class="entry">
        <form name="frm_unit" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            ...
            if ($action == "TAMBAH") {
                ...
                $_sql           = "SELECT `id_indikator6`, `bulan`, `ruangan`, `numerator`, `denumerator`,`nm_ruangan`,`id_menuindikator6`,`tahun` FROM indikator6 JOIN ruangan_unit ON ruangan_unit.id_ruangan = indikator6.ruangan WHERE id_indikator6='$id'";
            ...
            echo "<div align='center' class='link'>
                          <a href=?act=ListIndikator6&menu=$menu>| List Data |</a>
            ...
            if (isset($BtnSimpan)) {
                ...
                if ((!empty($bulan)) && (!empty($idruangan)) && (!empty($numerator)) && (!empty($denumerator)) && (!empty($menu)) && (!empty($tahun))) {
                    switch ($action) {
                        case "TAMBAH":
                            Tambah(" indikator6 ", "'0','$bulan','$idruangan','$numerator','$denumerator','$menu','$tahun'", " indikator6 ");
                            echo "<html><head><title></title><meta http-equiv='refresh' content='1;URL=?act=InputIndikator6&action=TAMBAH&menu=$menu'></head><body></body></html>";
                            break;
                        case "UBAH":
                            Ubah(" indikator6 ", " bulan='$bulan',ruangan='$idruangan',numerator='$numerator',denumerator='$denumerator',id_menuindikator6='$menu',tahun='$tahun' WHERE id_indikator6='$id'", " indikator6 ");
                            echo "<html><head><title></title><meta http-equiv='refresh' content='1;URL=?act=InputIndikator6&action=UBAH&id=$id&menu=$menu'></head><body></body></html>";
                            break;
                    }
                } else if (
