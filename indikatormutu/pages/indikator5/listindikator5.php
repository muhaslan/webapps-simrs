...
<div id="post">
    <div class="entry">
        ...
        <div align="center" class="link">
            <a href=?act=InputIndikator5&action=TAMBAH&menu=<?= $menu ?>>| Input Data |</a>
        ...
        <form name="frm_aturadmin" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            ...
            <div style="width: 100%; height: 78%; overflow: auto;">
                <?php
                $_sql = "SELECT * FROM `indikator5` JOIN ruangan_unit ON ruangan_unit.id_ruangan = indikator5.ruangan";
                ...
                if (mysqli_num_rows($hasil) != 0) {
                    ...
                    while ($baris = mysqli_fetch_array($hasil)) {
                        ...
                        echo "<tr class='isi' title='$baris[1] $baris[2]'>
                                  <td width='70'>
                                        <center>
                                        <a href=?act=InputIndikator5&action=UBAH&id=$baris[0]&menu=$menu>[edit]</a>";
                        echo "       </center>
                                </td>
                                <td>" . $baris["bulan"] . "</td>
                                <td>" . $baris["tahun"] . "</td>
