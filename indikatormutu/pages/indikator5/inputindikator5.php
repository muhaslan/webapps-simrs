    ...
    <div class="entry">
        <form name="frm_unit" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            ...
            if ($action == "TAMBAH") {
                ...
                $_sql           = "SELECT `id_indikator5`, `bulan`, `ruangan`, `numerator`, `denumerator`,`nm_ruangan`,`id_menuindikator5`,`tahun` FROM indikator5 JOIN ruangan_unit ON ruangan_unit.id_ruangan = indikator5.ruangan WHERE id_indikator5='$id'";
            ...
            echo "<div align='center' class='link'>
                          <a href=?act=ListIndikator5&menu=$menu>| List Data |</a>
            ...
            if (isset($BtnSimpan)) {
                ...
                if ((!empty($bulan)) && (!empty($idruangan)) && (!empty($numerator)) && (!empty($denumerator)) && (!empty($menu)) && (!empty($tahun))) {
                    switch ($action) {
                        case "TAMBAH":
                            Tambah(" indikator5 ", "'0','$bulan','$idruangan','$numerator','$denumerator','$menu','$tahun'", " indikator5 ");
                            echo "<html><head><title></title><meta http-equiv='refresh' content='1;URL=?act=InputIndikator5&action=TAMBAH&menu=$menu'></head><body></body></html>";
                            break;
                        case "UBAH":
                            Ubah(" indikator5 ", " bulan='$bulan',ruangan='$idruangan',numerator='$numerator',denumerator='$denumerator',id_menuindikator5='$menu',tahun='$tahun' WHERE id_indikator5='$id'", " indikator5 ");
                            echo "<html><head><title></title><meta http-equiv='refresh' content='1;URL=?act=InputIndikator5&action=UBAH&id=$id&menu=$menu'></head><body></body></html>";
                            break;
                    }
                } else if (
