    ...
    <div class="entry">
        <form name="frm_unit" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            ...
            if ($action == "TAMBAH") {
                ...
                $_sql           = "SELECT `id_indikator4`, `bulan`, `ruangan`, `numerator`, `denumerator`,`nm_ruangan`,`id_menuindikator4`,`tahun` FROM indikator4 JOIN ruangan_unit ON ruangan_unit.id_ruangan = indikator4.ruangan WHERE id_indikator4='$id'";
            ...
            echo "<div align='center' class='link'>
                          <a href=?act=ListIndikator4&menu=$menu>| List Data |</a>
            ...
            if (isset($BtnSimpan)) {
                ...
                if ((!empty($bulan)) && (!empty($idruangan)) && (!empty($numerator)) && (!empty($denumerator)) && (!empty($menu)) && (!empty($tahun))) {
                    switch ($action) {
                        case "TAMBAH":
                            Tambah(" indikator4 ", "'0','$bulan','$idruangan','$numerator','$denumerator','$menu','$tahun'", " indikator4 ");
                            echo "<html><head><title></title><meta http-equiv='refresh' content='1;URL=?act=InputIndikator4&action=TAMBAH&menu=$menu'></head><body></body></html>";
                            break;
                        case "UBAH":
                            Ubah(" indikator4 ", " bulan='$bulan',ruangan='$idruangan',numerator='$numerator',denumerator='$denumerator',id_menuindikator4='$menu',tahun='$tahun' WHERE id_indikator4='$id'", " indikator4 ");
                            echo "<html><head><title></title><meta http-equiv='refresh' content='1;URL=?act=InputIndikator4&action=UBAH&id=$id&menu=$menu'></head><body></body></html>";
                            break;
                    }
                } else if (
